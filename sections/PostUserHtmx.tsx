...
export default function PostUserHtmx({ title }: PostUserProps) {
    ...
    return (
        ...
        <div>
            ...
            <form class="mb-7" hx-post="http://localhost:3000/user" hx-trigger="submit" hx-target="#resultRegister">
